...
class TestScheduler:
    ...
    def test_should_refresh_first_time(
        ...
        with patch("rpi_weather_display.client.scheduler.is_quiet_hours", return_value=False):
    ...
    def test_calculate_sleep_time(
        ...
        with patch("rpi_weather_display.client.scheduler.is_quiet_hours", return_value=True):
        ...
        with (
            patch("rpi_weather_display.client.scheduler.is_quiet_hours", return_value=False),
