...
class TestPowerStateUpdateCoverage:
    ...
    def test_update_power_state_without_timestamp(self, power_manager: PowerStateManager) -> None:
        ...
        with (
            ...
            patch(
                "rpi_weather_display.utils.power_manager.is_battery_critical", return_value=False
            ),
            patch(
                "rpi_weather_display.utils.power_manager.should_conserve_power", return_value=False
            ),
...
class TestSystemMetricsExceptionCoverage:
    ...
    def test_get_system_metrics_general_exception(self, power_manager: PowerStateManager) -> None:
        ...
        with patch("rpi_weather_display.utils.power_manager.file_exists", side_effect=Exception("Test exception")):
